...
% MAKETRIALS Make trials from file
%
% USE:
...
%   DOES NOT USE TESTTABLE. It is the experimenter's responsibility to control the contingencies (and the intermixing) of testing trials.
